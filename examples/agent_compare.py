...
# --- the agent -------------------------------------------------------------- #
AGENT_SYSTEM = "You are a careful reasoning agent. Think before answering. End with a line: 'Final answer: <answer>'."

# --- the task (a trap: the naive answer is 100 cats; the correct answer is 3) -#
TASK = "If 3 cats can catch 3 mice in 3 minutes, how many cats are needed to catch 100 mice in 100 minutes?"
...
async def main() -> None:
    ...
    for mode in MODES:
        ...
        print(
            f"[route={rr.route} | cost=${rr.cost:.6f} | "
    ...
    if verdict:
        ...
        if correct_modes:
            ...
            print(
                f"  Cheapest correct setting: router-{cheapest_correct} "
